            ...
            case .success(let user):
                ...
                PersistenceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
                    ...
                    guard let error = error else {
                        self.presentGFAlertOnMainThread(title: "Success!", message: "You've just successfully favorited this user! 🥳", buttonTitle: "Ok")
                        return
                    }
                    self.presentGFAlertOnMainThread(title: "Someting went wrong", message: error.rawValue, buttonTitle: "Ok")
                }
...
extension FollowersListVC: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let navCtrl = UINavigationController(rootViewController: destinationVC)
